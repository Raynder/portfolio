...
<body class="bg-gray-100 font-sans">
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <!-- Sidebar -->
        <div class="sidebar bg-white w-full md:w-1/4 lg:w-1/5 xl:w-1/6 p-6 flex flex-col items-center">
            <!-- Profile Picture -->
        ...
        <!-- Main Content -->
        <div class="main-content w-full md:w-3/4 lg:w-4/5 xl:w-5/6">
            <!-- Navbar -->
                    ...
                    <ul class="hidden md:flex space-x-8">
                        ...
                        <li class="dropdown relative">
                            <a href="#" class="hover:text-white flex items-center">
                                Pages <i class="fas fa-chevron-down ml-1 text-xs"></i>
                            </a>
                            <ul class="dropdown-menu absolute left-0 mt-2 w-48 bg-white text-blue-900 rounded shadow-lg hidden">
                                <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Portfolio</a></li>
                                <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Services</a></li>
                                <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Testimonials</a></li>
                            </ul>
                        </li>
